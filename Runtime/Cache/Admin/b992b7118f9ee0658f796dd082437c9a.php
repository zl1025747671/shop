...
<h1>
<span class="action-span"><a href="<?php echo U('Admin/cat/catlist');?>">商品分类</a></span>
<span class="action-span1"><a href="#">ECSHOP 管理中心</a> </span><span id="search_id" class="action-span1"> - 添加分类 </span>
<div style="clear:both"></div>
</h1>

<div class="main-div">
  <form action="<?php echo U('admin/cat/catadd');?>" method="post" name="theForm" enctype="multipart/form-data">
      ...
      <tr>
        ...
        <td>
          <select name="parent_id">
                       ...
                       <?php echo str_repeat('&nbsp;&nbsp;',$v['lev']),$v['cat_name']; ?></option><?php } ?>
