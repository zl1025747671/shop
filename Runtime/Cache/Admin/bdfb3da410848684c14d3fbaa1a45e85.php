...
<div class="form-div">
  ...
  <form action="" name="searchForm">
    ...
    <option value="1">诺基亚</option><option value="10">金立</option><option value="9">联想</option><option value="8">LG</option>
    <option value="7">索爱</option><option value="6">三星</option><option value="5">夏新</option><option value="4">飞利浦</option>
    <option value="3">多普达</option><option value="2">摩托罗拉</option><option value="11">  恒基伟业</option></select>


    <select name="intro_type"><option value="0">全部</option>
    <option value="is_best">精品</option>
    <option value="is_new">新品</option>
    <option value="is_hot">热销</option><option value="is_promote">特价</option>
...
<table cellpadding="3" cellspacing="1">
  <tr>
    <th>
      ...
      <a href="#">编号</a><img src="/shop/Public/Admin/images/sort_desc.gif"/>    </th>
  ...
  <tr>
    ...
    <td align="center"><img src="/shop/Public/Admin/images/yes.gif"  /></td>
    <td align="center"><img src="/shop/Public/Admin/images/yes.gif"  /></td>
    <td align="center"><img src="/shop/Public/Admin/images/yes.gif"  /></td>
    <td align="center"><img src="/shop/Public/Admin/images/yes.gif"  /></td>
    ...
    <td align="center"><span ><?php echo ($v["cat_name"]); ?></span></td>
      ...
      <a href="<?php echo U('admin/goods/goodsedit',array('goods_id'=>$v['goods_id']));?>" title="编辑"><img src="/shop/Public/Admin/images/icon_edit.gif" width="16" height="16" border="0" /></a>
      <a href="#" title="复制"><img src="/shop/Public/Admin/images/icon_copy.gif" width="16" height="16" border="0" /></a>
      <a href="<?php echo U('admin/goods/goodsdel',array('goods_id'=>$v['goods_id']));?>"  title="回收站"><img src="/shop/Public/Admin/images/icon_trash.gif" width="16" height="16" border="0" /></a>
      <a href="#" title="货品列表"><img src="/shop/Public/Admin/images/icon_docs.gif" width="16" height="16" border="0" /></a>          </td>
