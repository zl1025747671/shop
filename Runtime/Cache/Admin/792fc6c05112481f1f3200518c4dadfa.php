...
<div id="menu-div">
  <ul>
    ...
    <li><a href="<?php echo U('Admin/index/main');?>" target="main-frame">起始页</a></li>
    <li><a href="#" target="main-frame">设置导航栏</a></li>
        <li><a href="<?php echo U('Admin/goods/goodslist');?>" target="main-frame">商品列表</a></li>
        <li><a href="<?php echo U('Home/order/done');?>" target="main-frame">订单列表</a></li>
