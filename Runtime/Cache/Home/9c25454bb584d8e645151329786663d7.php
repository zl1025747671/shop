...
<div class="block1">
    <div class="site-bar"><font id="ECS_MEMBERZONE"> 您好，欢迎光临本店！ <a href="<?php echo U('Home/user/login');?>" style="color:#50884b">登录</a> |
        ...
        <div class="contentNew">
          <div class="l_box">
            ...
            <form action="" method="post" name="loginForm" id="loginForm">
              ...
              <label>
                <img src="<?php echo U('Home/user/yzm');?>" alt="" width="200px" height="40px" />
              </label>
                <div class="btns">
