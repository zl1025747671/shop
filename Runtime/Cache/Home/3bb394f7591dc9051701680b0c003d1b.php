...
<div class="block1">
    <div class="site-bar"><font id="ECS_MEMBERZONE">
        <?php if(check()): ?>您好:<font color="red">
      ...
      <ul class="sitelinks">
        <li><a href="./flow.php.htm"></a><a href="./flow.php.htm" title="查看购物车">购物车有<?php echo ($count['num']); ?> 件</a></li>
...
<div class="recommendContent entry-content" id="show_hot_area">
        <?php if(is_array($hot)): foreach($hot as $key=>$h): ?><div class="goodsbox1">
				<div class="imgbox1"><a href="<?php echo U('Home/goods/goods',array('goods_id'=>$h['goods_id']));?>"><img src="/.<?php echo ($h['goods_img']); ?>" alt="<?php echo ($h['goods_name']); ?>"></a></div>
    			 <a href="./goods.php-id=13.htm" title="热销商品"><?php echo ($h['goods_name']); ?></a><br>
...
<div class="recommendContent entry-content" id="show_best_area">
   <?php if(is_array($best)): foreach($best as $key=>$b): ?><div class="goodsbox1">
				<div class="imgbox1"><a href="<?php echo U('Home/goods/goods',array('goods_id'=>$b['goods_id']));?>"><img src="/.<?php echo ($b['goods_img']); ?>" alt="<?php echo ($h['goods_name']); ?>"></a></div>
			 <a href="<?php echo U('Home/goods/goods',array('goods_id'=>$b['goods_id']));?>" title="精品"><?php echo ($b['goods_name']); ?></a><br>
...
<div class="recommendContent entry-content" id="show_new_area">
   <?php if(is_array($new)): foreach($new as $key=>$n): ?><div class="goodsbox1">
				<div class="imgbox1"><a href="<?php echo U('Home/goods/goods',array('goods_id'=>$n['goods_id']));?>"><img src="/.<?php echo ($n['goods_img']); ?>" alt="<?php echo ($n['goods_name']); ?>"></a></div>
			 <a href="<?php echo U('Home/goods/goods',array('goods_id'=>$n['goods_id']));?>" title="新品上市"><?php echo ($n['goods_name']); ?></a><br>
